...
class PostDetailEndpoint(Resource):
    ...
    def patch(self, id):
        ...
        #If post does not exist, send error
        if post is None:
            return Response(
        ...
        #If post not owned by the logged in user, send error
    ...
    def delete(self, id):
        ...
        return Response(
            json.dumps({"Message": f"Post id={id} has been deleted successfully"}),
            mimetype="application/json",
            status=200,
        )
    ...
    def get(self, id):
        ...
        if (is_authorized_and_exists):
            ...
            return Response(
            json.dumps({"Message": f"Post id = {id} not authorized"}),
            mimetype="application/json",
            status=404,
        )
        # TODO: Add GET logic...
